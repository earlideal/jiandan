...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolButton_back_home = QtGui.QToolButton(self.centralwidget)
        self.toolButton_back_home.setMaximumSize(QtCore.QSize(16777215, 30))
        self.toolButton_back_home.setAutoRaise(True)
        self.toolButton_back_home.setObjectName(_fromUtf8("toolButton_back_home"))
        self.horizontalLayout.addWidget(self.toolButton_back_home)
        ...
        self.toolButton_manage_staff = QtGui.QToolButton(self.centralwidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.toolButton_manage_staff.sizePolicy().hasHeightForWidth())
        self.toolButton_manage_staff.setSizePolicy(sizePolicy)
        self.toolButton_manage_staff.setMaximumSize(QtCore.QSize(16777215, 30))
        self.toolButton_manage_staff.setAutoRaise(True)
        self.toolButton_manage_staff.setObjectName(_fromUtf8("toolButton_manage_staff"))
        self.horizontalLayout.addWidget(self.toolButton_manage_staff)
