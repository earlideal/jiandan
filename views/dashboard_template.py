...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolButton_6.setMinimumSize(QtCore.QSize(200, 50))
        self.toolButton_6.setObjectName(_fromUtf8("toolButton_6"))
        self.horizontalLayout_content.addWidget(self.toolButton_6)
        self.toolButton_7 = QtGui.QToolButton(self.centralwidget)
        self.toolButton_7.setMinimumSize(QtCore.QSize(200, 50))
        self.toolButton_7.setObjectName(_fromUtf8("toolButton_7"))
        self.horizontalLayout_content.addWidget(self.toolButton_7)
        self.toolButton_5 = QtGui.QToolButton(self.centralwidget)
        self.toolButton_5.setMinimumSize(QtCore.QSize(200, 50))
        self.toolButton_5.setObjectName(_fromUtf8("toolButton_5"))
        self.horizontalLayout_content.addWidget(self.toolButton_5)
