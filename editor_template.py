...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBox_currency = QtGui.QComboBox(Dialog)
        self.comboBox_currency.setMinimumSize(QtCore.QSize(120, 0))
        self.comboBox_currency.setObjectName(_fromUtf8("comboBox_currency"))
        self.gridLayout.addWidget(self.comboBox_currency, 1, 7, 1, 1)
